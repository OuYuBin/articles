...
class Category {
	...
	function to_html(& $html) {
		...
		$html .= "<h3><a href=\"/articles/articles.rss?filter=$this->id\"><img src=\"/images/rss.gif\" title=\"RSS feed for $this->title\" alt=\"[RSS]\" align=\"right\"/></a><a name=\"$this->id\">$this->title <i>[$count articles]</i></a></h3>";
